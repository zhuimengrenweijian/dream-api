...
var e=this,i=this.container,a=this.biz,r=this.mid,l=this.idx,c=i.getAttribute("data-url"),m=new Set,u=new Set,_=i.querySelector(".js_submit");
...
s.hasClass(t,"js_reason")?m.delete(i):u.delete(i)):(s.addClass(t,"feedback_tag_selected"),
s.hasClass(t,"js_reason")?m.add(i):u.add(i)),0===m.size&&0===u.size?s.addClass(_,"weui-btn_disabled"):s.removeClass(_,"weui-btn_disabled");
},this.submitDataHandler=function(n){
n.stopPropagation(),n.preventDefault();
var _=n.target;
if(!s.hasClass(_,"weui-btn_disabled")){
var h={
tacitly:Array.from(m),
keyword:Array.from(u)
},b={
biz_from:a,
mid_from:r,
idx_from:l,
...
e.stopPropagation();
},n.on(i,"click",".js_tag_item",this.tabClickEventHandler,!0),n.on(_,"click",this.submitDataHandler,!0),
