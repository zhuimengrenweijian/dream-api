...
var t=K[e],i=u.attr(t,"data-showed");
if("no"==i){
...
function C(e){
try{
for(var d=window.pageYOffset||document.documentElement.scrollTop,c=0;c<K.length;c+=F){
var m=K[c];
if(!(m.offsetTop>d+E.getInnerHeight()+100)){
var l=u.attr(m,"data-cpsstatus");
if("hide"==l){
m.setAttribute("data-cpsstatus","loading");
for(var g=""+c,_=1,h=c+1;h<K.length&&c+F>h;h++)g=g+"%2c"+h,_++;
var v=Math.ceil(1e7*Math.random());
if(""!==t("mockcps"))var b="/mp/cps_product_info?biz="+window.biz+"&mid="+window.mid+"&idx="+window.idx+"&cpslist="+g+"&sn="+window.sn+"&mockcps="+t("mockcps");else var b="/mp/cps_product_info?biz="+window.biz+"&mid="+window.mid+"&idx="+window.idx+"&cpslist="+g+"&sn="+window.sn+"&istempurl="+(window.is_temp_url||0)+"&random="+v;
!function(e,t,d){
w({
url:t,
type:"GET",
...
var c=K[e.product_list[t].index],m=e.product_list[t].template_id;
...
for(var l=c.getElementsByClassName("js_product_loop_content"),w=0;w<l.length;w++)for(var g in e.product_list[t].attr)l[w].setAttribute("data-"+g,e.product_list[t].attr[g]);
for(var _=c.getElementsByTagName("img"),w=0;w<_.length;w++)_[w].src=u.attr(_[w],"data-src");
!function(e,t){
...
}),""==document.getElementById("js_content").innerHTML.trim()&&S.setSum(24729,94,1);
var t=Math.random();
.001>t&&document.getElementById("js_read_area3")&&document.getElementById("js_read_area3").innerText&&document.getElementById("js_read_area3").innerText.indexOf("Pageview")>-1&&S.setSum(24729,95,1),
window.__wxjs_is_wkwebview&&S.setSum(28307,67,1);
}
try{
var K=document.getElementsByTagName("mpcps");
window.__addIdKeyReport("64469","15",K.length);
for(var U=0;U<K.length;U++){
K[U].setAttribute("data-cpsstatus","hide"),K[U].setAttribute("data-showed","no");
var G={
cps_isready:!1,
cps_state:"",
pid_type:"",
...
source_logo_url:"",
is_ad:1
},Y=u.attr(K[U],"data-templateid");
"list"==Y?K[U].innerHTML=n.tmpl(s,G,!1):"banner"==Y?K[U].innerHTML=n.tmpl(r,G,!1):"card"==Y&&(K[U].innerHTML=n.tmpl(a,G,!1));
}
}catch(X){
console.log(X);
}
...
try{
W.init(document.getElementById("js_tags"));
}catch(X){
console.log(X);
}
var $=void 0,Z=null;
O(),y.on(window,"scroll",O),C(),y.on(window,"scroll",D),window.is_new_msg&&-1!=navigator.userAgent.indexOf("MicroMessenger")&&(window.title&&(window.title=window.title.replace(/&#39;/g,"'").replace(/&nbsp;/g," ").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&amp;/g,"&")),
...
}),"1"===window.localStorage.getItem(t)&&z.report110809(30)),e)for(var d=document.getElementsByClassName("js_pay_qrcode"),p="/mp/paysubqrcode?action=get_article_qrcode&__biz="+window.biz+"&mid="+window.mid+"&idx="+window.idx+"&sn="+window.sn+"#wechat_redirect",c=0,l=d.length;l>c;c++)d[c].src=p;
...
if(!i){
if(!e&&g)return;
if((f.is_wxwork||!f.isWechat)&&!e)return void window.weui.alert("Make the payment in Weixin.");
g=!0,_=new Date;
}
var n=o.currentTarget;
if(!e&&1*n.dataset.ready===0)return!i&&B.show("Generating order..."),new Date-_>6e4?(B.hide(),
window.weui.alert("Payment timeout. Try again later."),void(g=!1)):setTimeout(b,100,{
currentTarget:n
},!0);
...
if(window.is_teenager)return window.weui.alert("青少年模式下不可付费"),S.setSum(232209,0,1),
void(g=!1);
if(window.is_temp_url)window.weui.alert("A temporary link is free. Please share it with caution to avoid content leakage.",function(){
...
var e=function(){
z.reportPayAppmsg(1),v.invoke("handleMPPageAction",{
action:"paySuccess",
fullUrl:window.location.href,
itemShowType:item_show_type
},function(e){
g=!1,z.report110809(e.err_msg.indexOf("ok")>-1?19:20),window.localStorage&&window.localStorage.setItem&&window.localStorage.setItem(t,"1"),
...
z.reportPay(o,1,t.order_id),e()):i.err_msg.indexOf("cancel")>-1?(g=!1,z.report110809(28),
z.reportPay(o,2,t.order_id),console.log("pay cancel")):i.err_msg.indexOf("fail")>-1?(g=!1,
...
sandbox:!!n.sandbox,
ontimeout:function(){
g=!1,window.weui.alert("Payment timeout. Try again later.");
},
methods:{
onPayEnd:function(i,n){
console.log("directPay res: ",i,n),1===i?(z.report110809(17),z.reportPay(o,1,t.order_id,n,i),
e()):-1===i&&/:cancel$/.test(n)?(g=!1,z.report110809(29),z.reportPay(o,2,t.order_id,n,i),
console.log("pay cancel")):(g=!1,z.report110809(18),z.reportPay(o,3,t.order_id,n,i),
...
case 202602:
window.weui.alert("You have already purchased this article. No additional payment required.",e);
break;
...
case 202617:
window.weui.alert("青少年模式下不可付费"),S.setSum(232209,0,1);
break;

default:
z.report110809(14),window.weui.alert("Order creation failed. Try again later.");
}
},
error:function(){
g=!1,window.weui.alert("System error. Try again later.");
},
complete:function(){
B.hide();
}
...
(V||navigator.userAgent.indexOf("Br_trunk")>-1)&&f.isIOS&&(s||d)&&!p?(console.info("[HEVC代理] 当前版本可以启用HEVC代理"),
...
is_https_res||J?e=e.http2https():("http:"==location.protocol||-1!=navigator.userAgent.indexOf("MicroMessenger"))&&(e=e.https2http())),
setTimeout(function(){
a.onload=function(){
...
window.__addIdKeyReport("28307",84)),o=at.addParam(o,"wxfrom","5",!0),is_https_res||J?(o=o.http2https(),
...
if(-1!=P){
if(console.log("[横屏滚动检测]",n-P),500>n-P)return void(P=-1);
}else P=-1;
if(e[t].ori==i()&&(e[t].scroll=o,e[t].istouchmove=!0,!a)){
var s=E.getInnerHeight()+o;
r.offsetTop<s&&(a=!0,S.setSum(59977,15,1));
}
});
}
}(),l("[Appmsg] href:"+location.href+"^^^ ua:"+window.navigator.userAgent),window.addEventListener?window.addEventListener("load",M,!1):window.attachEvent&&window.attachEvent("onload",M),
...
S.setSum(28307,18,1),f.isIOS&&S.setSum(28307,19,1),f.isAndroid&&S.setSum(28307,20,1);
},!1);
}(),function(){
...
var Et=Math.random();
if(2e-4>Et)try{
for(var kt=document.getElementsByTagName("img"),zt=window.screen.height,Bt=window.screen.width,Pt=0,Rt=window.devicePixelRatio,Pt="",U=0,Tt=kt.length;Tt>U;U++){
var St=kt[U].getAttribute("data-src");
if(St){
var Ot=kt[U].getBoundingClientRect();
Pt+=Bt+"|"+zt+"|"+Ot.left.toFixed(2)+"|"+(Bt-Ot.right).toFixed(2)+"|"+Ot.width.toFixed(2)+"|"+Rt.toFixed(2)+"|"+St+";";
}
}
w({
...
e("appmsg/popup_report.js")),z=e("appmsg/pay_report_utils.js"),B=e("appmsg/loading.js"),P=-1,R=e("appmsg/finance_communicate.js"),T=e("appmsg/topbar.js"),S=e("biz_wap/utils/jsmonitor_report.js"),O=e("appmsg/getForbidConfig.js"),C=e("appmsg/set_article_read.js"),q=C.setArticleRead,N=!1;
e("appmsg/wxwork_hidden.js");
var D=e("common/color/background_color.js"),L=e("common/color/light.js"),M=e("common/color/dark.js"),W=e("appmsg/tags_utils.js");
D.set({
bottom:[L["BG-0"],M["BG-0"]]
}),window.new_appmsg&&(e("page/appmsg_new/combo.css"),e("page/appmsg_new/not_in_mm.css")),
e("appmsg/finance_communicate.js");
var K=window.user_uin||0,U=Math.floor(K/100)%1e3,J=0!==K&&1001>U,V=!0,H="",F=5;
...
var G=window.performance||window.msPerformance||window.webkitPerformance;
if(!G||!G.timing)return;
