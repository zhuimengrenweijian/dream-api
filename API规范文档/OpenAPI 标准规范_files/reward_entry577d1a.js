...
return function(t){
if(t.preventDefault(),"link"===r&&S.is_teenager)return weui.alert("青少年模式下不可赞赏"),
void T.setSum(232209,0,1);
if("0"==S.user_can_reward)return void n("你已成为该公众号的黑名单用户，暂时无法赞赏。");
...
return weui.alert(e&&e>S.whisperMaxLen?"悄悄话不可以超过字":"Network unavailable. Try again later.");
},o=function(){
