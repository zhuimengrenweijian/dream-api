...
var o=n("biz_wap/jsapi/core.js"),e=n("common/navShadow.js"),i=n("common/keyboard.js"),t=n("biz_wap/utils/mmversion.js"),c=!i.onlyUseH5Keyboard||t.isAndroid,a=function(n){
...
onClose:function(){
e.hide(),"function"==typeof n.onClose&&n.onClose();
},
...
var i=""+o;
return e[i]=n.onClick,{
id:i,
label:n.label
};
})
},function(o){
/:ok$/.test(o.err_msg)?"function"==typeof e[o.id]&&e[o.id]():/:canceled$/.test(o.err_msg)?"function"==typeof n.onCancel&&n.onCancel():"action isn't supported"===o.err_desc||"action not support"===o.err_desc?a(n):"function"==typeof n.onFail&&n.onFail(o.err_msg);
});
}
};
...
}),this.state.androidShowingKeybroad=!0,this.state.androidTriggeringEmoji=!1,this.state.androidOriWinInnerHeight=window.innerHeight,
