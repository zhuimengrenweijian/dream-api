...
var t=e("biz_common/tmpl.js"),i=e("biz_wap/utils/ajax.js"),n=e("biz_wap/jsapi/core.js"),o=e("appmsg/related_article_tpl.html.js"),r=e("appmsg/related_article_item.html.js"),a=e("biz_wap/utils/openUrl.js"),s=e("biz_common/dom/event.js"),l=e("common/utils.js"),d=e("biz_common/dom/class.js"),c=e("biz_common/utils/url/parse.js"),m=e("common/comm_report.js"),u=e("appmsg/related_article_feedback.js"),p=e("biz_wap/utils/mmversion.js"),_=e("biz_wap/utils/device.js"),w=e("appmsg/set_font_size.js").setFontSize,g=e("biz_wap/utils/jsmonitor_report.js"),f=e("pages/utils.js"),h=f.getId,j=f.getByClass,v=f.qs,b=f.formatReadNum,y=f.getScrollTop,z=f.getDefaultFontSize,x=e("pages/scrollY.js"),T=l.getInnerHeight();
...
C=function(e){
e.target===R.area&&"height"===e.propertyName&&(R.area.style.overflow="visible",J());
};
var L=function(e,t){
var i=document.querySelector(".js_related_title"),n=6.5,o=2.25,r=0;
if(i){
var a=i.getBoundingClientRect().height;
a>0&&(o=a/z());
}
return 0===e?(R.area.style.overflow="hidden",R.area.style.margin="0",J()):(R.area.style.margin="12px 0 0",
r=e*n+o),R.area.style.height=r+"em",E&&e&&C&&C({
target:R.area,
propertyName:"height"
...
var e=arguments.length<=0||void 0===arguments[0]?0:arguments[0],n=arguments.length<=1||void 0===arguments[1]?F:arguments[1],o=parseFloat(window.getComputedStyle(R.main).marginTop),a=function(e){
if(E)L(e);else{
var t=24,i=R.area.getBoundingClientRect().top,n=L(e,!0)+t+o,r=R.bottomOpr.getBoundingClientRect().top,a=i+n;
if(!(r>T||0>a)){
var s=i-t;
s>0&&T>a||x.start(0>s?{
distance:s,
...
Array.prototype.forEach.call(k(t.tmpl(r,{
list:o,
reason:W,
begin:e
})),function(e){
s.appendChild(e.cloneNode(!0));
}),R.list.appendChild(s),I=v("div",R.placeholder).getBoundingClientRect().height,
R.placeholder.parentNode.removeChild(R.placeholder),R.placeholder=null,H(function(e){
e?a(i.list.length):L(i.list.length);
...
ExpType:i.exptype,
ExtInfo:i.ext_info
},M)),p.isWechat&&!p.isMpapp?n.invoke("openWebViewUseFastLoad",{
url:o,
...
if(E=i,!E){
var n=R.bottomOpr.getBoundingClientRect(),r=n.top,a=n.bottom;
if(r>T||0>a)return;
}
