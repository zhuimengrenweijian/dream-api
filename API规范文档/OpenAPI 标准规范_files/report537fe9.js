...
t.__fixAndroidWebviewControllerReinitBug())),void(o.find(".js_btn_opr")[0].innerHTML="Pause"));
...
t._showPlayControllBar()),t.__endCountTime(),t._trigger("pause"),o.find(".js_btn_opr")[0].innerHTML="Play");
...
var o=e.list||[];
if(o.length){
for(var r=t.__getCurTime(1),u=0;u<o.length;u++){
var _=o[u],l={
html:t.__decodeEmoji(_.content),
index:Math.max(_.time_point,r),
...
var n=r[i],s=b.replace("#name#",n.style);
if(n.cn){
